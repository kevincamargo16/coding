...
btn_times = tk.Button(root,text="*", command=lambda: add_to_calculation("*"), width=5,font=("Ariel,14"))
...
btn_equal = tk.Button(root,text="=", command= evaluate_calculations, width=11,font=("Ariel,14"))
